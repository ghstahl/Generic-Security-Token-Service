...
{
    internal class Authorize2RequestValidator : IAuthorize2RequestValidator
    {
        private readonly IdentityServerOptions _options;
        private readonly IAuthorizationCodeStore _authorizationCodeStore;
        private readonly ExtensionGrantValidator _extensionGrantValidator;
        private readonly ICustomAuthorize2RequestValidator _customRequestValidator;
        ...
        public Authorize2RequestValidator(IdentityServerOptions options, 
            IAuthorizationCodeStore authorizationCodeStore, 
            IResourceOwnerPasswordValidator resourceOwnerValidator, 
            IProfileService profile, 
            ExtensionGrantValidator extensionGrantValidator, 
            ICustomAuthorize2RequestValidator customRequestValidator, 
            ScopeValidator scopeValidator, ITokenValidator tokenValidator, IEventService events, ISystemClock clock, ILogger<TokenRequestValidator> logger)
        {
            _logger = logger;
            _options = options;
            _clock = clock;
        ...
        /// client
        /// </exception>
        public async Task<Authorize2RequestValidationResult> ValidateRequestAsync(NameValueCollection parameters, ClientSecretValidationResult clientValidationResult)
        {
        ...
        private async Task<Authorize2RequestValidationResult> RunValidationAsync(Func<NameValueCollection, Task<Authorize2RequestValidationResult>> validationFunc, NameValueCollection parameters)
        {
            ...
            var customValidationContext = new CustomAuthorize2RequestValidationContext { Result = result };
        ...
        private async Task<Authorize2RequestValidationResult> ValidateAuthorizationCodeRequestAsync(NameValueCollection parameters)
        {
        ...
        private async Task<Authorize2RequestValidationResult> ValidateClientCredentialsRequestAsync(NameValueCollection parameters)
        {
        ...
        private async Task<Authorize2RequestValidationResult> ValidateResourceOwnerCredentialRequestAsync(NameValueCollection parameters)
        {
        ...
        private async Task<Authorize2RequestValidationResult> ValidateRefreshTokenRequestAsync(NameValueCollection parameters)
        {
        ...
        private async Task<Authorize2RequestValidationResult> ValidateExtensionGrantRequestAsync(NameValueCollection parameters)
        {
        ...
        private Authorize2RequestValidationResult ValidateAuthorizationCodeWithProofKeyParameters(string codeVerifier, AuthorizationCode authZcode)
        {
        ...
        private Authorize2RequestValidationResult Valid(Dictionary<string, object> customResponse = null)
        {
            return new Authorize2RequestValidationResult(_validatedRequest, customResponse);
        }

        private Authorize2RequestValidationResult Invalid(string error, string errorDescription = null, Dictionary<string, object> customResponse = null)
        {
            return new Authorize2RequestValidationResult(_validatedRequest, error, errorDescription, customResponse);
        }
